...
describe('SpamDetector', () => {
  ...
  describe('URL detection', () => {
    it('should detect HTTP URLs', () => {
      ...
      expect(result.reason).to.equal('Message contains URLs');
    });
  ...
  describe('Suspicious patterns', () => {
    it('should detect Discord invite links', () => {
      ...
      expect(result.isSpam).to.be.true;
      expect(result.reason).to.equal('Message contains suspicious content');
    });
  ...
  describe('Message length', () => {
    it('should reject messages exceeding maximum length', () => {
      ...
      expect(result.isSpam).to.be.true;
      expect(result.reason).to.equal('Message exceeds maximum length');
    });
  ...
  describe('Excessive repetition', () => {
    it('should detect repeated words', () => {
      ...
      expect(result.isSpam).to.be.true;
      expect(result.reason).to.equal('Message contains excessive repetition');
    });
  ...
  describe('Excessive capitals', () => {
    it('should detect messages with excessive caps', () => {
      ...
      expect(result.isSpam).to.be.true;
      expect(result.reason).to.equal('Message contains excessive capital letters');
    });
  ...
  describe('Custom patterns', () => {
    ...
    it('should work with multiple custom patterns', () => {
      ...
      expect(result1.isSpam).to.be.true;
      expect(result2.isSpam).to.be.true;
    });
  });
